...
<div className="home-content">
  <div className="content-container">
    {/* <h1 className="headline">Empower Your Online Presence<br className='sm:block hidden'/> with Virtual Support</h1> */}
    {/* <h1 className="headline">Boost Your Digital Experience<br className='sm:block hidden'/>with Virtual Assistance</h1> */}
    {/* <h1 className="headline">Transform Your Online Services<br className='sm:block hidden'/>with Expert Virtual Help</h1> */}
    {/* <h1 className="headline">Unlock Superior Online Support<br className='sm:block hidden'/>for Your Website Today</h1> */}
    <h1 className="headline">Unlock Superior Online Support<br className='sm:block hidden'/>with Tailored Virtual Solutions</h1>
    ...
    {/* <p className="subtitle">Empower Your Digital Strategy<br className='sm:block hidden'/>with Our Professional Virtual Support Team.</p> */}
    <p className="subtitle">Revolutionize Your Support System<br className='sm:block hidden'/>With A Virtual Assistant That Answers Your Customer Needs.</p>
    ...
    <div className="content-container">
      <Features>
        ...
        <Feature index={4} centered style={{
          ...
          }}><a href="https://mdxjs.com/blog/v2" target="_blank" style={{ color: 'currentColor' }}>MDX 2</a> lets you use Components inside Markdown, <br className="hide-medium"/>with huge performance boost</p>
        </Feature>
        ...
        <Feature index={6} large id="search-card" href="/docs/docs-theme/theme-configuration#search">
          <div style={{ zIndex: 2}}>
            <h3>SmartFull-text search, <br/>zero-config needed</h3>
            <p>The documentation indexes your content automatically at build-time and performs incredibly fast full-text search via [FlexSearch](https://github.com/nextapps-de/flexsearch).</p>
          </div>
        ...
        <Feature index={8} id="a11y-card" className='card-with-border' style={{
          ...
          <p>The docs respects system options <br className="show-on-mobile"/>such as <b>Increase Contrast</b> and <b>Reduce Motion</b>.</p>
        </Feature>
        ...
        <Feature index={10} large>
          ...
          <p className="subtitle"><Link className="!no-underline" href="/docs">Start using Osmanity →</Link></p>
        </Feature>
      </Features>
    </div>
  </div>
